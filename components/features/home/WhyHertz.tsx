const pillars = [
  {
    title: "Solo proyectos de ingeniería",
    description:
      "Nos especializamos en proyectos técnicos avanzados. No ofrecemos reparaciones domésticas, cambio de tomacorrientes ni servicios de mantenimiento básico.",
    icon: (
